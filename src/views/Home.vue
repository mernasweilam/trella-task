<template>
  <div class="home">
      <AppBar/>
    <div class="content">
      <FilterShipments @needDriverActivated="fetchShipments" @needNearbyDriverActivated="fetchNearbyShipments"/>
...
export default {
 ...
 //fetch nearby shipments
  fetchNearbyShipments(){
    trellaAxios.get(`https://case-api.trella.app/marketplace?lng=30&lat=30`)
    .then(data => {
      this.cards = data.data
     })
  }
